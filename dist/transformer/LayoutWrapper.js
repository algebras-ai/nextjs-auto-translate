...
function wrapLayoutWithIntl(code, filePath) {
    ...
    const intlWrapperImport = t.importDeclaration([t.importDefaultSpecifier(t.identifier('IntlWrapper'))], t.stringLiteral((0, packageInfo_js_1.runtimeImportPath)('runtime/server/IntlWrapper')));
