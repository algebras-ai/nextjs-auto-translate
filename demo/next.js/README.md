# Next.js 16 Example Project

This is a simple Next.js 16 example project. Follow the steps below to add automatic internationalization with `algebras-auto-intl`.
