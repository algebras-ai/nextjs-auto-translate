...
const runLoader = (code: string, opts: any, resourcePath?: string) => new Promise<string>((resolve, reject) => {
...
describe("webpack loader", () => {
  ...
  return (
    <html>
      <body>{children}</body>
			...
			const out = await runLoader(layoutCode, { sourceMap: { files: {} } }, resourcePath);
			
			expect(out).toContain("IntlWrapper");
			expect(out).toContain("algebras-auto-intl/runtime/server/IntlWrapper");
			expect(out).toContain("<IntlWrapper>");
		});
  ...
  return <div>Hello</div>;
			...
			const out = await runLoader(code, { sourceMap: { files: {} } }, resourcePath);
...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return <div>Hello</div>;
			...
			expect(out).toContain("algebras-auto-intl/runtime/client/components/Translated");
		});
  ...
  return <div>Hello</div>;
			...
			const componentRelativePath = getRelativePath(`${process.cwd()}/src/Component.tsx`);
  ...
  return <main><h1>Hello</h1></main>;
			...
			expect(out).toContain("algebras-auto-intl/runtime/client/components/LocaleSwitcher");
		});
